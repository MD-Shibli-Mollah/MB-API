...
@Test
public void testgetPsopspAccountInfo() {
  String requestName = "getPsopspAccountInfo";
...
String body = "";
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-jbl.getPsopspAccountInfo", body, headers);
