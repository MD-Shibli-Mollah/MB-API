...
@Test
public void testgetJblDocumentImages() {
  String requestName = "getJblDocumentImages";
...
headers.put("imageReference", "");// THIS IS REQUIRED
...
String body = "";
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-jbl.getJblDocumentImages", body, headers);
