...
public class PartyProductsTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("party-products.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testcreateSavingsAccount() {
  String requestName = "createSavingsAccount";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-products.createSavingsAccount", body, headers);
