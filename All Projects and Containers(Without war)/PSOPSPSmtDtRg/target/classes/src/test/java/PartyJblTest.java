...
@Test
public void testgetPsopspStmtRange() {
  String requestName = "getPsopspStmtRange";
...
String body = "";
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-jbl.getPsopspStmtRange", body, headers);
