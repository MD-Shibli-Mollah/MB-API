...
@Test
public void testgetPsopspAllAccounts() {
  String requestName = "getPsopspAllAccounts";
...
String body = "";
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-jbl.getPsopspAllAccounts", body, headers);
