...
@Test
public void testgetPsopspStmtN() {
  String requestName = "getPsopspStmtN";
...
headers.put("numberOfTransaction", "");
...
String body = "";
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-jbl.getPsopspStmtN", body, headers);
