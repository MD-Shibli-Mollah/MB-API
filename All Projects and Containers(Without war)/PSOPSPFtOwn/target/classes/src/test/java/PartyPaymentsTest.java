...
public static void init() {
   helper = new CamelUnitTestHelper("party-payments.service.1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testcreatePsopspFundsTransferOwn() {
  String requestName = "createPsopspFundsTransferOwn";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-payments.createPsopspFundsTransferOwn", body, headers);
