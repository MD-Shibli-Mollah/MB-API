...
import com.temenos.t24.api.records.ebjblsmsparameter.LimitAmtClass;
...
public class FtSmsAuthRtn extends RecordLifecycle {
    ...
    public void postUpdateRequest(java.lang.String application, java.lang.String currentRecordId,
        ...
        if (transactionContext.getCurrentFunction().equals("AUTHORISE")) {
            ...
            String dbtAcct = ftRec.getDebitAcctNo().getValue();
            String cdtAcct = ftRec.getCreditAcctNo().getValue();

            String dbtAmt = ftRec.getAmountDebited().getValue();
            String cdtAmt = ftRec.getAmountCredited().getValue();
            if (cdtAmt.equals("")) {
                cdtAmt = dbtAmt;
            }

            String dbtCurr = ftRec.getDebitCurrency().getValue();
            String cdtCurr = ftRec.getCreditCurrency().getValue();
            if (cdtCurr.equals("")) {
                cdtCurr = dbtCurr;
            }
            ...
            String smsEvent0 = parameterRecord.getSmsEvent(0).getSmsEvent().getValue();
            ...
            if (smsEvent0.equals("DEBIT")) {
                ...
                if (dbtCusPhone.length() == 11 || dbtCusEmail != "") {
                    ...
                    Double dblTxnAmt    = Double.valueOf(dbtAmt);
