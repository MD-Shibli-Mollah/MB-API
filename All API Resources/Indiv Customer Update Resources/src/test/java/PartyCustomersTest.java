...
@Test
public void testupdateIndivCustomer() {
  String requestName = "updateIndivCustomer";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-customers.updateIndivCustomer", body, headers);
