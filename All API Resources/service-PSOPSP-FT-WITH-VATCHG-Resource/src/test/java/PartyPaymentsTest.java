...
@Test
public void testcreatePsopspFtWithChgVat() {
  String requestName = "createPsopspFtWithChgVat";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-payments.createPsopspFtWithChgVat", body, headers);
