...
@Test
public void testgetJblAccountBalance() {
  String requestName = "getJblAccountBalance";
...
String body = "";
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-jbl.getJblAccountBalance", body, headers);
