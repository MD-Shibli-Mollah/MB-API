...
public void testupdateIndividualCustomer() {
  String requestName = "updateIndividualCustomer";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-customers.updateIndividualCustomer", body, headers);
